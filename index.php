...
<div class="mainslider glide">
    <div class="glide__track" data-glide-el="track">
        <ul class="glide__slides">
            <!-- Добавляем динамическое обновление слайдов через WP -->
            <?php
...
<!--                    <img src="<?php //the_field('about_img'); ?>" alt="про компанию">--> <!-- подставляем Ссылку на изображение (вариант с сылкой) из группы полей -->
            ...
            <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                <h1 class="title underlined"><?php the_field('about_title'); ?></h1> <!-- подставляем title из группы полей -->
                <div class="about__text">
                    <?php the_field('about_descr'); ?> <!-- подставляем описание из группы полей -->
                </div>
...
<div class="toys" id="toys">
    <div class="container">
        ...
        <div class="toys__wrapper">
            ...
            ?>)"> <!-- Размещение фонового изображения, через настройку записи и вывод заглушки, если изображения нет -->
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="toys__alert">
                    <span><?php the_field('toys_ask', 2); ?></span> <?php the_field('toys_alert', 2); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="184" title="Форма отзывов"]'); ?> <!-- Установка контакт формы 7 -->
                </div>
            </div>
        </div>
        <div class="row mt70">
