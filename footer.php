...
<div class="reply">
    <div class="reply__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="185" title="Форма обратной связи"]'); ?> <!-- Установка контакт формы 7 -->
    </div>
</div>
<footer>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-3">
                <div class="footer__logo">
                    <?php the_custom_logo(); ?> <!-- подключение лого первый вариант (вместе с ссылкой) а меняем на див (второй вариант есть в шапке)-->
                </div>
            </div>
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <a href="<?php the_field('instagram', 2); ?>" class="footer__social-item"> <!-- Вывод поля группы социальные сети-->
...
<?php
    wp_footer(); //  В момент этого события обычно подключаются скрипты (jquery и другие), стили (css сайта) и разные SEO мета-теги страницы (title, description, robots)
?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyfVCnJ--KmYeI-6NY2QRv_gTB3oleFEA"></script> <!-- подключение карты google -->
